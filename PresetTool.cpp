...
// PresetTool.cpp: 애플리케이션에 대한 클래스 동작을 정의합니다.
//
...
BEGIN_MESSAGE_MAP(CPresetToolApp, CWinApp)
...
// 유일한 CPresetToolApp 개체입니다.

CPresetToolApp theApp;

const GUID CDECL BASED_CODE _tlid =
		{0x3e602001,0x4af8,0x4000,{0x8d,0x3e,0x6e,0xe5,0x63,0x22,0x6a,0x76}};
...
BOOL CPresetToolApp::InitInstance()
{
...
int CPresetToolApp::ExitInstance()
{
	AfxOleTerm(FALSE);
