...
CPresetToolDlg::CPresetToolDlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_PRESETTOOL_DIALOG, pParent)
{
	EnableActiveAccessibility();
...
// CPresetToolDlg 메시지 처리기

BOOL CPresetToolDlg::OnInitDialog()
{
...
//  이 함수를 호출합니다.
HCURSOR CPresetToolDlg::OnQueryDragIcon()
{
...
void CPresetToolDlg::OnCancel()
{
	if (CanExit())
		CDialogEx::OnCancel();
}

BOOL CPresetToolDlg::CanExit()
{
